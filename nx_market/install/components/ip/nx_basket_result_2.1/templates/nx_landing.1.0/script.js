...
var nx_basket_link = '/ajax/basket.php';
...
function item_recount(my_object, direction) {
	...
	$.post(nx_basket_link, {NX_ID:nx_ids, NX_COUNT:nx_counter_val, NX_ACTION:"change", nx_basket_result_ajax: 'Y'}, function(data) {  
		...
		//$(".nx-basket-result").empty().append(data.HTML);
