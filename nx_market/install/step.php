...
<?=bitrix_sessid_post()?>
<input type="hidden" name="lang" value="<?=LANGUAGE_ID?>" />
<input type="hidden" name="id" value="nx_market" />
...
<p class="nx_market-install-fields">
	<table cellpadding="3" cellspacing="0" border="0" width="0%">
		...
		<tr>
			<td>&nbsp;</td>
			<td>
				<div class="nx_market-install-field nx_market-install-field-copy">
					<label for="public_dir"><?=GetMessage("COPY_FOLDER")?></label>
					<input type="input" name="public_dir" id="public_dir" value="update" size="40" />
				</div>
				<div class="nx_market-install-field nx_market-install-field-rewrite">
...
<style>
	p.nx_market-install-fields table, p.nx_market-install-fields td,  p.nx_market-install-fields label{font-size:100%;}
</style>
<script language="JavaScript">
<!--
